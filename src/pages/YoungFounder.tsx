          ...
          <div className="grid lg:grid-cols-[1fr,1.1fr] gap-8 lg:gap-12 items-center pt-8 lg:pt-12 pb-16">
            ...
            >
              ...
              <div className="glass inline-flex items-center gap-2 rounded-full px-4 py-2 mb-6">
                <GraduationCap className="h-4 w-4 text-primary fill-primary/20" />
                <span className="text-xs font-semibold text-foreground/70 uppercase tracking-wider">
                  Coaching für Schüler, Azubis & Studenten
                </span>
              </div>
                ...
                <div className="relative w-full max-w-xs mx-auto">
                  ...
                  <div className="glass-card relative rounded-2xl p-2">
                    <div className="relative rounded-xl overflow-hidden">
                      <img 
                        src={youngFounderHero} 
                        alt="Young Founder Coaching"
              ...
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed mb-8 max-w-md mx-auto lg:mx-0">
                Während andere noch nach dem richtigen Weg suchen, baust du dir schon dein eigenes KI-Business auf. Ohne Startkapital, ohne Erfahrung.
              </p>
              ...
              <div className="relative w-full max-w-sm sm:max-w-lg lg:max-w-xl">
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-sm font-bold text-foreground">Perfekter Start</span>
                  </div>
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Lerne von Grund auf, wie du mit KI Geld verdienst.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <span className="text-xs font-semibold text-foreground">Für Studenten</span>
                </motion.div>
              </div>
            </motion.div>
          </div>
