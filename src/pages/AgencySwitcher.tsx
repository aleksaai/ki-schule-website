...
import agencySwitcherHero from "@/assets/agency-switcher-hero.png";
            ...
            >
              ...
              <div className="glass inline-flex items-center gap-2 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-xs font-semibold text-foreground/70 uppercase tracking-wider">
                  Für Agenturinhaber, Coaches & Berater
                </span>
              </div>
                ...
                <div className="relative w-full max-w-xs mx-auto">
                  ...
                  <div className="glass-card relative rounded-2xl p-2">
                    <div className="relative rounded-xl overflow-hidden">
                      <img 
                        src={agencySwitcherHero} 
                        alt="Agency Switcher Coaching"
              ...
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed mb-8 max-w-md mx-auto lg:mx-0">
                Nutze deine Erfahrung als Agenturinhaber, Coach oder Berater und erweitere dein Angebot mit KI-Dienstleistungen. Der Markt wartet auf dich.
              </p>
              ...
              <div className="flex items-center justify-center lg:justify-start gap-4 sm:gap-6 mt-10 text-xs sm:text-sm flex-wrap">
                <div className="flex items-center gap-2">
                  <span className="font-bold text-foreground">Erfahrung</span>
                  <span className="text-muted-foreground">nutzen</span>
                </div>
                <span className="text-border hidden sm:inline">•</span>
                <div className="flex items-center gap-2">
                  <span className="font-bold text-foreground">KI-Skills</span>
                  <span className="text-muted-foreground">erweitern</span>
                </div>
                <span className="text-border hidden sm:inline">•</span>
                <div className="flex items-center gap-2">
                  <span className="font-bold text-foreground">Mehr</span>
              ...
              <div className="relative w-full max-w-sm sm:max-w-lg lg:max-w-xl">
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-sm font-bold text-foreground">Schneller Wechsel</span>
                  </div>
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Erweitere dein Portfolio in wenigen Wochen um KI-Dienstleistungen.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <span className="text-xs font-semibold text-foreground">Für Profis</span>
                </motion.div>
              </div>
            </motion.div>
          </div>
