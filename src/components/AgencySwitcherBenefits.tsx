      ...
      <div className="container relative mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto">
            Deine Erfahrung ist dein Kapital — nutze sie, um im KI-Markt durchzustarten.
          </p>
        </motion.div>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
          >
            <span className="relative z-10">Jetzt Erstgespräch buchen</span>
...
export default AgencySwitcherBenefits;
