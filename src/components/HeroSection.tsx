      ...
      <div className="container relative mx-auto px-6 lg:px-8">
        ...
        >
          <div className="glass rounded-full px-3 py-2 flex items-center gap-2">
            ...
            <button className="btn-liquid-glass text-foreground px-4 py-2 rounded-full text-sm font-semibold ml-1">
              Jetzt starten
            </button>
          </div>
        </motion.nav>
        ...
        <div className="grid lg:grid-cols-[1fr,1.1fr] gap-10 lg:gap-12 items-center pt-8 lg:pt-12 pb-16">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <motion.button 
                className="btn-liquid-glass-accent text-foreground px-7 py-4 rounded-full text-base font-semibold flex items-center gap-2 group"
