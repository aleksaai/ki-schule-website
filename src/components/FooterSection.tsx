...
const FooterSection = () => {
  ...
  const footerLinks = [
    ...
    },
    {
      title: "Online-Kurse",
      links: [
        { label: "KI-Agentur Starter", href: "/coming-soon" },
        { label: "KI-Agenten Masterclass", href: "/coming-soon" },
        { label: "Workflow-Automation", href: "/coming-soon" },
        { label: "Vibe Coding Business", href: "/coming-soon" },
        { label: "Testkunden Gewinnung", href: "/coming-soon" },
      ],
    },
    {
      title: "Ressourcen",
      ...
      <div className="container relative mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-6">
          ...
          >
            ...
            <p className="text-muted-foreground text-xs sm:text-sm leading-relaxed max-w-xs mx-auto lg:mx-0 mb-6">
              Baue deine eigene KI-Agentur auf – mit professionellem Coaching und einer starken Community.
            </p>
            
            {/* Social Links - Under description on desktop */}
